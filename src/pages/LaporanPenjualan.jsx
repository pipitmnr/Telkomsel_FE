...
import {ButtonGroup, Dropdown,DropdownButton,Container, Row, Col, Button, Table} from "react-bootstrap"
           ...
           <Container>
               ...
               <Row className="baris">
                   ...
                   <Col md="2">
                       ...
                       <DropdownButton className="d-inline-block align-center" title={this.state.dates_first}>
                           <Dropdown.Item onClick={()=>  this.setState({dates_first:"1/2/2020"})}>1/2/2020</Dropdown.Item>
                        </DropdownButton><p> &nbsp;Hingga&nbsp; </p>
                       
                        <DropdownButton className="d-inline-block align-center" title={this.state.dates_last}>
                           <Dropdown.Item onClick={()=> this.setState({dates_last:"10/2/2020"})}>10/2/2020</Dropdown.Item>
                         </DropdownButton>
                   ...
                   <Col md="2">
                       <Dropdown as={ButtonGroup}>
                           <DropdownButton className="d-inline-block align-center" title={this.props.filter_payment}>
                           <Dropdown.Item onClick={()=>store.setState({filter_payment:"Terbayar"})}>Terbayar</Dropdown.Item>
                           <Dropdown.Item onClick={()=>store.setState({filter_payment:"Terkirim"})}>Terkirim</Dropdown.Item>
...
export default connect("filter_payment,filter_kluster",actions)(withRouter(LaporanJual));